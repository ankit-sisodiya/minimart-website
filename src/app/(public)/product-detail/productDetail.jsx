...
const ProductDetail = () => {
  ...
  const productImage = [productImageA.src, productImageB.src, productImageC.src];
  return (
    <div>
                ...
                <div className="row">
                  <div className="col-md-3">
                    <div className="pd-image-detail-column">
                      {productImage.map((x, i) => {
                        return (
                          <div key={i} className="product-image-option" onClick={()=>{
                            setImagechange(i)
                          }}>
                            <Image
                              height={100}
                  ...
                  <div className="col-md-9">
                    <Image
                      height={100}
                      width={500}
                      src={productImage[imageChange]}
                      alt="product-image"
                      className="product-enlarge"
                    />
                  </div>
                </div>
              </div>
            ...
            <div className="col-md-6">
              <div className="product-detail-side">
                ...
                <div className="product-describe">
                  {/* <p className="watch-number">
                    <BsFillEyeFill /> 230 people are viewing this right now
                  </p> */}
                  <span className="product-price-detail">
                    AED <span className="pd-price">35.00</span>{" "}
                    <span className="pd-cut-price">AED 38.00</span>{" "}
                    <span className="pd-offer">60% Off</span>
                  </span>
                  <p className="stock-option">In Stock</p>
                  <span className="pd-sold">
                    Sold By <span className="brand-head">MyMarket</span>
                  </span>
                </div>
                ...
                <div className="pd-description">
                  ...
                  <p>
                    At 70 calories on average, the natural sweetness of a Envy®
                    apple makes it a healthy and just as delicious alternative
                    to a sugary snack. Envy® in the kitchen, Envy® apples are
                    naturally sweet, so you can reduce the amount of sugar a
                    recipe says you should add. Our apples also hold together
                    well when cooked. Picked perfect for sweet snackisfaction
                    Suitable for vegetarians Product life guaranteed for 3 days
                    including delivery day, with an average of 8.5 days.
                  </p>
